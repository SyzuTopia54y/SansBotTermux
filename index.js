...
*/
const A187 = '👾SansBot👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/SYZUGANS.ID'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+62895618417504'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/KkKzk03EV3TETxUw9DvSIo'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://www.youtube.com/channel/SYZUTOPIA'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] SansBOT ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => SansBotTermux`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => SansBotTermux`)
})
...
conn.sendMessage(id, ' *Owner SansBot wa.me/+62895618417504* ' ,MessageType.text);
}
else if (text == '!help'){
...
conn.sendMessage(id, ' *Creator SYZUTOPIA wa.me/+62895618417504* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾SansBot👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/SYZUGANS.ID' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾SansBot👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/SYZUGANS.ID' ,MessageType.text);
}
